...
export function collectSession(genome, region, tracks, themeName, customTheme, labelWidth) {
  return {
    ...
    tracks: tracks.map((t, idx) => ({
      ...
      autoScaleVisible: t.autoScaleVisible === true,
      linkScale: t.linkScale === true,
      logScale: t.logScale || false,
      barAutoWidth: t.barAutoWidth !== false,
      barWidth: t.barWidth || 2,
      showOutline: t.showOutline || false,
      outlineColor: t.outlineColor || null,
      outlineSmooth: t.outlineSmooth || 0,
      showBars: t.showBars !== false,
      showNucleotides: t.showNucleotides !== false,
      fwdColor: t.fwdColor || null,
      revColor: t.revColor || null,
